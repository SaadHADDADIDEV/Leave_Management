            ...
            <nav class="cyan darken-1">
                <div class="nav-wrapper row">
                    ...
                    <div class="header-title col s3">
                        <span class="chapter-title">TS immobilier</span>
                    </div>
            ...
            <div class="row">
                <div class="col s12">
                    <div class="page-title">
                        <h4>Récupération mot de pass</h4>
                    </div>
                                ...
                                <div class="row">
                                    <form class="col s12" name="signin" method="post">
                                        ...
                                        <div class="col s12 right-align m-t-sm">
                                            ...
                                            <input type="submit" name="submit" value="Connexion" class="waves-effect waves-light btn teal">
                                        </div>
                                    </form>
                                </div>
                            </div>
