...
?>
    ...
    <body>
        ...
        <main class="mn-inner">
            <div class="row">
                <div class="col s12">
                    <div class="page-title">Changer mot de pass </div>
                </div>
                                ...
                                <form class="col s12" name="chngpwd" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-field col s12">
                                            ...
                                            <label for="password">Confirmer mot de pass</label>
                                        </div>


                                        <div class="input-field col s12">
                                            <button type="submit" name="change" class="waves-effect waves-light btn indigo m-b-xs" onclick="return valid();">Changer</button>
