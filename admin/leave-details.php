...
?>
    ...
    <head>
        ...
        <!-- Title -->
        <title>Admin | Détails de congé </title>
        ...
        <!-- Theme Styles -->
        <link href="../assets/css/alpha.mine.css" rel="stylesheet" type="text/css" />
    ...
    <body>
        ...
        <main class="mn-inner">
            <div class="row">
                <div class="col s12">
                    <div class="page-title" style="font-size:24px;">Détails de congé</div>
                </div>

                <div class="col s12 m12 l12">
                    <div class="card">
                        <div class="card-content">
                            <span class="card-title">Détails de congé</span>
                            ...
                            <table id="example" class="display responsive-table ">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            ...
                                            <tr>
                                                <td style="font-size:16px;"> <b>Nom : </b></td>
                                            ...
                                            <tr>
                                                <td style="font-size:16px;"><b>Adresse email : </b></td>
                                                <td><?php echo htmlentities($result->EmailId); ?></td>
                                                <td style="font-size:16px;"><b>Numéro de télephone : </b></td>
                                            ...
                                            <tr>
                                                ...
                                                <td>De <?php echo htmlentities($result->ToDate); ?> à <?php echo htmlentities($result->FromDate); ?></td>
                                            ...
                                            <tr>
                                                <td style="font-size:16px;"><b>Remarque d'admin :</b></td>
                                                <td colspan="5"><?php
                                            ...
                                            <tr>
                                                <td style="font-size:16px;"><b>Date de réponse : </b></td>
                                                <td colspan="5"><?php
                                            ...
                                            <?php
                                            $dateDebut = strtotime($fromdate);
                                            $dateFin = strtotime($todate);
                                            $differenceJours = ($dateFin - $dateDebut) / (60 * 60 * 24);
                                            if (isset($_POST['update'])) {
                                                // Supposez que $soldeConges contient le solde actuel depuis la base de données

                                                // Calculer la différence de jours
                                                $dateDebut = strtotime($_POST['fromdate']);
                                                $dateFin = strtotime($_POST['todate']);
                                                $differenceJours = ($dateFin - $dateDebut) / (60 * 60 * 24);
                                                $soldeConges = $_POST['AA'];
                                                // Mettre à jour le solde de congés
                                                $soldeConges -= $differenceJours;

                                              
                                                    echo '<script>document.getElementById("A").innerText = "'.$soldeConges.'";</script>';
                                                }
                                            ...
                                            ?>
                                                <tr>
                                                    <td colspan="5">
                                                        <a class="modal-trigger waves-effect waves-light btn" href="#modal1">Prendre&nbsp;Action</a>
                                                        <form name="adminaction" method="post">
                                                            <div id="modal1" class="modal modal-fixed-footer" style="height: 60%">
                                                                <div class="modal-content" style="width:90%">
                                                                    <h4>Décision d'admin</h4>
                                                                    <select class="browser-default" name="status" required="">
                                                                        <option value="">Prendre action : </option>
