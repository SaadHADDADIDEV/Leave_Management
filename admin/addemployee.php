...
?>
    ...
    <body>
        ...
        <main class="mn-inner">
            <div class="row">
                <div class="col s12">
                    <div class="page-title">Ajouter employé</div>
                </div>
                                                ...
                                                <div class="col m6">
                                                    <div class="row">
                                                        ...
                                                        <div class="input-field col  s12">
                                                            <label for="empcode">Employé Code(Unique)</label>
                                                        ...
                                                        <div class="input-field col s12">
                                                            <label for="confirm">Confirmer mot de pass </label>
                                                ...
                                                <div class="col m6">
                                                    <div class="row">
                                                        ...
                                                        <div class="input-field col m6 s12">
                                                            ...
                                                            <input style="padding-top:0.5cm;" id="birthdate" name="dob" type="date" class="datepicker" autocomplete="off">
                                                        </div>
