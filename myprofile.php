...
?>
    ...
    <body>
        ...
        <main class="mn-inner">
            <div class="row">
                <div class="col s12">
                    <div class="page-title">Modifier employé</div>
                </div>
                                                        ...
                                                        if ($query->rowCount() > 0) {
                                                            foreach ($results as $result) {               ?>
                                                                <div class="input-field col  s12">
                                                                    <label for="empcode">Employé Code</label>
                                                ...
                                                <div class="col m6">
                                                    <div class="row">
                                                        ...
                                                        <div class="input-field col m6 s12">
                                                            ...
                                                            <input style="padding-bottom:0.1cm;" id="birthdate" name="dob" class="datepicker" value="<?php echo htmlentities($result->Dob); ?>">
                                                        </div>
